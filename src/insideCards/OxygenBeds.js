...
import JSONDATA from "../JSON/OXYGEN_BED_DATA.json";
      ...
      <div className="icubeds__mid">
        ...
        ></input>
         {(searchTerm != "") ? (
            ...
            <a
                href={`https://twitter.com/search?q=${searchTerm}%20oxygen%20beds%20&src=typed_query&f=live`}
            ...
            ></TwitterIcon>
                Live Oxygen Beds Results For <h4> {searchTerm} 
                </h4>
              </a>
