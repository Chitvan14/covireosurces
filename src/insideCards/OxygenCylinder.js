...
import JSONDATA from "../JSON/CYLINDER_DATA.json";
      ...
      <div className="oxygen">
        ...
        <div className="oxygen__mid">
          ...
          {(searchTerm != "") ? (
            ...
            <a
                href={`https://twitter.com/search?q=${searchTerm}%20oxygen%20cans&src=typed_query&f=live`}
            ...
            ></TwitterIcon>
                Live Oxygen Cans Results For <h4> {searchTerm} 
                </h4>
              </a>
